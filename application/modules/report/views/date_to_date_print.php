...
<body class="container pt-5">
  ...
  <div class="row pl-3 pr-3">
    ...
    <div class="col-md-5" style="border: 1px solid black;">
      ...
      <h5 class="display-5 text-break" style="text-align: left;">
        <?php echo $account[0]['name'];?><br>
        <?php if ($type == 'supplier') {
          echo $account[0]['city'];
        }elseif ($type == 'customer') {
          echo $account[0]['address'];
        }  ?><br>
        <?php echo $account[0]['phone']; ?><br>
      </h5>
    </div>
  </div>
  <div class="row">&nbsp;</div>
...
<table width="100%">
  ...
  foreach ($invoice as $key => $value) { 
    ...
    <tr style="text-align: center;">
      <td colspan="1" class="border1"> <?php echo 'I -'.$value['id'];?></td>
      ...
      <td colspan="1" class="border1"> <?php echo $value['remaining'];?>
