                ...
                <div class="portlet-body form " style="padding-top:15px;"> 
                  ...
                  <!-- BEGIN FORM-->
                        ...
                        if (isset($hidden) && !empty($hidden))
                            echo form_open_multipart(ADMIN_BASE_URL . 'report/submit_income_statement/' . $update_id, $attributes, $hidden);
                        else
                            echo form_open_multipart(ADMIN_BASE_URL . 'report/submit_income_statement', $attributes);
                        ?>
                  <div class="form-body">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group">
                          <?php
                              ...
                              ?>
                          <?php echo form_label('Month', 'month', $attribute); ?>
